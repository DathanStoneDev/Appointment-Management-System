...
public class CustomerDAOImpl {
    ...
    public static ObservableList<Appointment> getAllAppointments() {
        ...
        String sql = "SELECT a.Appointment_ID, a.Title, a.Description, a.Location, a.Type, a.Start, a.End, a.Customer_ID, c.Contact_Name FROM appointments a JOIN contacts c ON c.Contact_ID = a.Contact_ID";
        ...
        try(Statement statement = DatabaseConnection.getConnection().createStatement()) {
            ...
            while(rs.next()) {
                ...
                //Think I need to use a dateTimeFormatter for the data in the database.
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
